!(function(s, t, e) {
    ...
    if (s(".vc_row[id]").length) {
      ...
      s(".vc_row[id]").each(function() {
        ...
        2 < e.length &&
          n >=
            s(this).offset().top -
              s(".header_trans-fixed").outerHeight() -
              s("#wpadminbar").outerHeight() &&
            s(".site-main-menu li:not(.menu-item-has-children) > a")
              .filter('[href="#' + e + '"]')
              .closest("li:not(.menu-item-has-children)")
              .addClass("active")
              .siblings()
              .removeClass("active");
      });
  ...
  function a() {
    ...
    s("#wpadminbar").length
      ? ((e = i + n), s(".site-header").css("margin-top", i))
      : (e = n),
      s(t).width() < a
        ? s(".menu-wrapper").css("padding-top", e + "px")
        : s("#wpadminbar").length &&
          s(".site-header").hasClass("header_trans-fixed")
        ? s(".menu-wrapper").css("padding-top", i + "px")
        : s(".menu-wrapper").css("padding-top", "0"),
      s("#wpadminbar").length &&
        s(t).width() < 768 &&
        s("#wpadminbar").css({ position: "fixed", top: "0" });
  }
  function i() {
    var e = s(".menu-wrapper").attr("data-top");
    t.outerWidth < e || s(".site-header").hasClass("topmenu-arrow")
      ? (s(".menu-item-has-children i").length ||
          (s("header .menu-item-has-children").append(
            '<i class="fa fa-angle-down"></i>'
          ),
          s("header .menu-item-has-children i").addClass("hide-drop")),
        s("header .menu-item-has-children i").on("click", function() {
          s(this).hasClass("animation") ||
            (s(this)
              .parent()
              .toggleClass("is-open"),
            s(this).addClass("animation"),
            s(this)
              .parent()
              .siblings()
              .removeClass("is-open")
              ...
              .prev(".sub-menu")
              .slideUp(250),
            s(this).hasClass("hide-drop")
              ? (s(this).closest(".sub-menu").length ||
                  s(".menu-item-has-children i")
                    .addClass("hide-drop")
                    .next(".sub-menu")
                    .hide(250),
                s(this)
  ...
  s(t).on("scroll load", function() {
    30 <= s(this).scrollTop()
      ? (s(".site-header.header_trans-fixed").length &&
          (s(".site-header.header_trans-fixed")
            .not(".fixed-dark")
            .addClass("pix-header-fixed"),
          s(".fixed-dark").addClass("bg-fixed-dark"),
          s(".sticky-logo, .header-button-scroll").show(),
          s(".main-logo, .header-button-default").hide()),
        s(".right-menu.modern").length &&
          s(".right-menu.modern")
      ...
      : (s(".site-header.header_trans-fixed").length &&
          ...
          s(".fixed-dark").removeClass("bg-fixed-dark"),
          s(".sticky-logo, .header-button-scroll").hide(),
          s(".main-logo, .header-button-default").show()),
        s(".right-menu.modern").length &&
          s(".right-menu.modern")
            .closest(".fixed-header")
    ...
    s(".toggle-menu").on("click", function(e) {
      ...
      s('<div class="mask-overlay">')
        ...
        s("#wpadminbar").length
          ? s(".sidebar-open .site-nav").css("top", "46px")
    ...
    s(e).on("click", function(e) {
      s(e.target).closest(".search-icon-wrapper.ico-style").length ||
        s(".ico-style .close-search")
          .parent()
    ...
    s(".additional-nav-close, .additional-menu-overlay").on(
      "click",
      function() {
        s(".additional-menu-wrapper").removeClass("menu-open"),
          s(".menu-wrapper").removeClass("additional-menu-open");
      }
    ),
    s(t).on("load", function() {
      !(function() {
        s(".aside-nav").on("click", function() {
          return (
            s(".aside-menu").toggleClass("active-menu"),
            s(".site-header").toggleClass("active-menu"),
            !1
          );
        }),
        ...
        if (
          (t.outerWidth >= e
            ? (s(".menu-wrapper").on("click", function(e) {
                e.target.closest(".aside-menu") ||
                  s(".sub-menu-open").slideUp(250);
              }),
              s(".aside-menu .menu-item-has-children a").addClass("hide-drop"),
              s(".aside-menu .menu-item a").on("click", function() {
                s(this)
                  .parent()
            ...
            : s(".menu-item-has-children a").removeClass("hide-drop"),
          s(".aside-fix").length && s(t).width() > e)
        ) {
