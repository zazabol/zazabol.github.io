    ...
    general: function() {
      d(".saaspik-dropdown li").on("click", function(t) {
        var e = d(t.target),
          ...
          n = a.find("span"),
          s = i.find("input");
        (i.hasClass("init") || (s.is(":checked") && !e.hasClass("selected"))) &&
          (i.removeClass("init"),
          i.find("li.selected").removeClass("selected"),
          e.addClass("selected"),
          i.attr(
            "data-val",
            e.attr("data-val") || "" == e.attr("data-val")
              ? e.attr("data-val")
              : e.text().trim()
          ),
        ...
        d(document).on("keydown", function(t) {
          return !(
            ...
            (t.ctrlKey && t.shiftKey && 75 == t.keyCode) ||
            (t.metaKey && t.shiftKey && 91 == t.keyCode)
          );
        });
    },
    swiperSlider: function() {
      d(".swiper-container").each(function() {
        ...
        new Swiper(t, {
          ...
          autoplay: { delay: n, disableOnInteraction: !1 },
    ...
    googleMap: function() {
      d(".gmap3-area").each(function() {
        ...
        t.gmap3({
          ...
          return { position: t.getCenter(), icon: a };
        });
      });
    },
